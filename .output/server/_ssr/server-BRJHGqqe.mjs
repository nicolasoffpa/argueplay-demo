import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-boIEPa30.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-APKPZrmW.mjs");
